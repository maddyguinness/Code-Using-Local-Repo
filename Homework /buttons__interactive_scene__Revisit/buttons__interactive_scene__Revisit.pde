...
void draw() {
  ...
  for (int i =0; i <hillArray.length; i++) {

    fill(0, 100, 0);
    ellipse(hillArray[i], 800, 1000, 800);
    println(hillArray);
  }
...
//couldn't figure out how to use arrays for my stars as they contain two triangles...
